...
const Icons = {
    ...
    chartBar: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>`,
    
    settings: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m5.2-13.2l-4.2 4.2m0 6l4.2 4.2M23 12h-6m-6 0H1m18.2 5.2l-4.2-4.2m-6 0l-4.2 4.2"></path></svg>`,
    ...
    flask: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6v7l5 8a2 2 0 0 1-2 3H6a2 2 0 0 1-2-3l5-8V3z"></path><line x1="9" y1="3" x2="15" y2="3"></line></svg>`,
    
    sync: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>`,
...
function createIcon(name, className = '') {
    const iconSvg = Icons[name] || Icons.info;
    return `<span class="icon ${className}">${iconSvg}</span>`;
}

/**
 * Replace emoji with icon in an element
 * @param {HTMLElement} element - Element to replace emoji in
 * @param {string} iconName - Icon name to use
 */
function replaceEmojiWithIcon(element, iconName) {
    if (!element) return;
    element.innerHTML = createIcon(iconName);
}
